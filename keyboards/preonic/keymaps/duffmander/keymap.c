...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |  Fn  | Ctrl | Alt  | CMD  |Lower |    Space    |Raise |  CMD |      |      |      |
     * `-----------------------------------------------------------------------------------'
     */
    ...
    MO(_BOTH), KC_LCTL, KC_LALT, KC_LGUI,  LOWER,  KC_SPC,  KC_SPC,   RAISE,  KC_RGUI,  KC_NO,   KC_NO,    KC_NO
    ),
    ...
    /* Raise (Falls through to Lower)
     * ,-----------------------------------------------------------------------------------.
     * | Vol -| Vol +| TODO-play/pause|      |      |      |      |      |      |      |      |      |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |      |      |      |      |      |      |      |      |      |      |      |
     * |------+------+------+------+------+-------------+------+------+------+------+------|
     * |      |      |      |      |      |      | Left | Down |  Up  | Right|      |      |
    ...
    [_RAISE] = LAYOUT_preonic_grid(
      KC_KB_VOLUME_DOWN, KC_KB_VOLUME_UP, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                _______,         _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                _______,         _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______, _______,
                _______,         _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                _______,         _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
